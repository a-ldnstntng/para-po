    ...
    <div className={`relative ${!isLast ? 'pb-3.5' : ''}`}>
      <div className="flex items-start gap-3">
        ...
        <div className="flex flex-col items-center flex-shrink-0">
          <div className="w-6 h-6 rounded-full bg-slate-900 text-white font-utility font-bold text-xs flex items-center justify-center shadow-sm">
            {stepNum}
          </div>
          {!isLast && (
        ...
        {/* Step Content */}
        <div className="flex-1 bg-slate-50 border border-slate-200 rounded-lg p-3 sm:p-3.5">
          ...
          <div className="flex items-center justify-between gap-2 flex-wrap mb-1">
            ...
            {step.fare_estimate_php !== null && step.fare_estimate_php !== undefined && (
              <span className="font-utility text-xs font-bold text-amber-700">
          ...
          {/* Instruction */}
          <p className="font-body text-xs sm:text-sm text-slate-800 leading-snug">
            {step.instruction}
          </p>
