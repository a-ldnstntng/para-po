  ...
  return (
    <header className="w-full flex flex-col items-center pt-6 pb-2">
      ...
      <div className="w-full max-w-xl mx-auto bg-white border-2 border-slate-900 rounded-xl p-5 sm:p-6 text-center shadow-[4px_4px_0px_rgba(15,23,42,0.1)] relative">
        ...
        <div className="mt-2 pt-2 border-t border-slate-200 flex items-center justify-center gap-3">
      ...
      <div className="w-full max-w-xl mx-auto mt-4 flex justify-center gap-1.5 sm:gap-2 flex-wrap px-1">
        {ROUTE_TAGS.map((label) => (
          <button
            ...
            type="button"
            className="font-display text-xs sm:text-sm font-bold tracking-wide px-3 py-1 rounded bg-white hover:bg-amber-500 hover:text-slate-950 text-slate-800 border-1.5 border-slate-900 transition-all cursor-pointer shadow-[2px_2px_0px_rgba(15,23,42,0.1)] active:translate-x-0.5 active:translate-y-0.5"
