...
export default function ArchiveList({ routes, isLoading, onConfirm, onDelete }: ArchiveListProps) {
  ...
  return (
    <div className="space-y-3.5 w-full">
      ...
      <div className="transit-panel p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-l-4 border-amber-500">
        <div>
        ...
        <div className="w-full sm:w-auto relative">
          ...
          <input
            ...
            className="w-full sm:w-64 bg-slate-50 text-slate-900 font-body text-xs rounded-lg border border-slate-300 pl-8 pr-3 py-2 placeholder:text-slate-400 focus:outline-none focus:border-amber-600 focus:bg-white transition-all shadow-xs"
          />
        </div>
      </div>
          ...
          <div key={route.id}>
            {expandedId === route.id ? (
              ...
              <div
                ...
                className="transit-panel p-4 cursor-pointer hover:border-amber-500 hover:bg-slate-50/80 transition-all shadow-xs group border-l-2 border-l-slate-300 hover:border-l-amber-500"
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span className="font-utility text-xs text-amber-600 font-bold">➔</span>
